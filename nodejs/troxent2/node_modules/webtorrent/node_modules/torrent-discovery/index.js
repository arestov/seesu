...
Discovery.prototype.setTorrent = function (torrent) {
  ...
  if (self.dht) {
    ...
    else listen(self.dht, 'ready', self._dhtLookupAndAnnounce.bind(self), self)
  }
}
...
Discovery.prototype._createDHT = function (port) {
  ...
  reemit(self.dht, self, ['error', 'warning'], addDestroyer)
  listen(self.dht, 'peer', function (addr, infoHash) {
...
Discovery.prototype._createTracker = function () {
  ...
  reemit(self.tracker, self, ['peer', 'warning', 'error'], addDestroyer)
  self.tracker.start()
}
