...
// https://github.com/isaacs/sax-js/blob/afa7083425beafb4dd39829e006c52b5ef8cc4cd/lib/sax.js
...
function SAXParser (strict, opt) {
  ...
  parser.attribList = []
  parser.isSelfClosing = parser.opt.isSelfClosing || noop; 
...
function openTag (parser, selfClosing) {
  ...
  if (tag.isSelfClosing) closeTag(parser)
}
