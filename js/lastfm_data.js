...
lfm.get('geo.getmetros', {}).done(function(r){
  ...
  var сountries = spv.makeIndexByField(nr, 'country', true);
  for (var country in сountries){
    сountries[country] = spv.filter(сountries[country], 'name')
  }
  console.log(dizi = сountries)
})
*/
define(function(){
"use strict";
